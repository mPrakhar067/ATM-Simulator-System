...
public class Signup3 extends JFrame implements ActionListener{
	...
	Signup3(){
		super("NEW ACCOUNT REGISTRATION PAGE3");
		...
		l4 = new JLabel("XXXX-XXXX-XXXX-0101");
		l4.setFont(new Font("",Font.BOLD,18));
		
		l5 = new JLabel("Your 16 Digit Card Number");
		l5.setFont(new Font("",Font.BOLD,12));
		
		l6 = new JLabel("This will appear on the ATM Card");
		l6.setFont(new Font("",Font.BOLD,12));
		...
		l9.setFont(new Font("",Font.BOLD,12));
		
		l10 = new JLabel("Services Required");
		l10.setFont(new Font("",Font.BOLD,18));
		...
		c4 = new JCheckBox("Email Address");
		...
		c7.setFont(new Font("",Font.BOLD,12));
		c7.setBackground(Color.WHITE);
		
		r1 = new JRadioButton("Saving Account");
		r1.setFont(new Font("",Font.BOLD,16));
		r1.setBackground(Color.WHITE);
		
		r2 = new JRadioButton("Fixed Deposit Account");
		r2.setFont(new Font("",Font.BOLD,16));
		r2.setBackground(Color.WHITE);
		
		r3 = new JRadioButton("Current Account");
		r3.setFont(new Font("",Font.BOLD,16));
		r3.setBackground(Color.WHITE);
		
		r4 = new JRadioButton("Recurring Deposit Account");
		r4.setFont(new Font("",Font.BOLD,16));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		long numb = (rn.nextLong()% 90000000L) + 5040936000000000L;
		long first8 = Math.abs(numb);
		
		long numbe = (rn.nextLong()%9000L) + 1000L;
		long first4 = Math.abs(numbe);
